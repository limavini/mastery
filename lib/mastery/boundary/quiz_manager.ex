defmodule Mastery.Boundary.QuizManager do
  ...
  # use is a Macro. Macros are code that writes code. This one adds GenServer callbacks.
  use GenServer

  # takes an argument and translates it into our initial state
  ...
  def handle_call({:add_template, quiz_title, template_fields}, _, quizzes) do
    new_quizzes =
