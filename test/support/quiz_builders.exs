defmodule QuizBuilders do
  @moduledoc """
  This one does two simple things. First, it aliases key modules so the user can use the abbreviated names. Then, it inserts the functions into the test module as if those functions had been defined there. Now, our quizzes can do

  ​ 	`assert Quiz.function(build_data())`
  instead of

  ​ 	`assert Mastery.Core.Quiz.function(Mastery.QuizBuilder.build_data())`
  """
